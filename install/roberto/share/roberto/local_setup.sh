...
: ${AMENT_CURRENT_PREFIX:="/root/ROS2/turtlebot3_ws/src/roberto/install/roberto"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/roberto/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/roberto/environment/path.sh"
